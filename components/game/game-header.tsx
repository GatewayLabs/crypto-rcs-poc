  ...
  return (
    <>
      <div className="bg-white flex w-full items-center justify-between flex-wrap rounded-3xl max-md:max-w-full">
        <div className="bg-zinc-950 self-stretch flex flex-col items-center justify-center w-full sm:w-auto px-6 py-2 rounded-3xl max-md:px-5 h-auto border-b border-white">
