...
export default function GameBoard() {
  return (
    <div className="px-6 py-8 max-md:max-w-full font-normal">
      ...
      <div className="flex w-full items-center gap-4 flex-wrap mt-8 max-md:max-w-full">
        <button className="bg-[rgba(20,9,31,1)] border self-stretch min-h-[356px] flex-1 shrink basis-[0%] my-auto px-8 py-10 rounded-lg border-[rgba(141,12,255,1)] border-solid max-md:px-5 flex flex-col justify-between items-center">
          <img
            loading="lazy"
            ...
            className="aspect-[1.27] object-contain w-[162px] flex-grow"
            alt="Rock"
          />
        ...
        <button className="bg-[rgba(20,9,31,1)] border self-stretch min-h-[356px] flex-1 shrink basis-[0%] my-auto px-8 py-10 rounded-lg border-[rgba(141,12,255,1)] border-solid max-md:px-5 flex flex-col justify-between items-center">
          <img
            ...
            className="aspect-[0.78] object-contain w-[129px] flex-grow"
            alt="Paper"
          />
        ...
        <button className="bg-[rgba(20,9,31,1)] border self-stretch min-h-[356px] flex-1 shrink basis-[0%] my-auto px-8 py-10 rounded-lg border-[rgba(141,12,255,1)] border-solid max-md:px-5 flex flex-col justify-between items-center">
          <img
            ...
            className="aspect-[0.82] object-contain w-[133px] flex-grow"
            alt="Scissors"
          />
          <div className="text-[rgba(141,12,255,1)] text-2xl font-normal leading-none text-center uppercase mt-[90px] max-md:mt-10">
            Scissors
